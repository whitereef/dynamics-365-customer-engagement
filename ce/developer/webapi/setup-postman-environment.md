...
> 
> You can use the values supplied in these instructions from postman.  However, when building your own application, you should register your own AAD application.
> 
