---
title: "ContactInvoices Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
description: "Includes schema information and supported messages for the ContactInvoices entity."
ms.date: 03/28/2019
...
search.app: 
  ...
  - D365CE
---
# ContactInvoices Entity Reference
...
|-|-|-|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/contactinvoicescollection<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|contactinvoices_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
Relationship details provided where the ContactInvoices entity is the first entity in the relationship. Listed by **SchemaName**.
...
<xref href="Microsoft.Dynamics.CRM.contactinvoices?text=contactinvoices EntityType" />