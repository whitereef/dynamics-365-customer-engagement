...
See msfp_emailtemplate Entity [msfp_emailtemplate_PrincipalObjectAttributeAccesses](msfp_emailtemplate.md#BKMK_msfp_emailtemplate_PrincipalObjectAttributeAccesses) One-To-Many relationship.

### <a name="BKMK_msfp_question_PrincipalObjectAttributeAccesses"></a> msfp_question_PrincipalObjectAttributeAccesses

**Added by**: Microsoft Forms Pro Solution

See msfp_question Entity [msfp_question_PrincipalObjectAttributeAccesses](msfp_question.md#BKMK_msfp_question_PrincipalObjectAttributeAccesses) One-To-Many relationship.
...
See msfp_questionresponse Entity [msfp_questionresponse_PrincipalObjectAttributeAccesses](msfp_questionresponse.md#BKMK_msfp_questionresponse_PrincipalObjectAttributeAccesses) One-To-Many relationship.

### <a name="BKMK_msfp_survey_PrincipalObjectAttributeAccesses"></a> msfp_survey_PrincipalObjectAttributeAccesses

**Added by**: Microsoft Forms Pro Solution

See msfp_survey Entity [msfp_survey_PrincipalObjectAttributeAccesses](msfp_survey.md#BKMK_msfp_survey_PrincipalObjectAttributeAccesses) One-To-Many relationship.
...
See msfp_surveyinvite Entity [msfp_surveyinvite_PrincipalObjectAttributeAccesses](msfp_surveyinvite.md#BKMK_msfp_surveyinvite_PrincipalObjectAttributeAccesses) One-To-Many relationship.

### <a name="BKMK_msfp_surveyresponse_PrincipalObjectAttributeAccesses"></a> msfp_surveyresponse_PrincipalObjectAttributeAccesses

**Added by**: Active Solution Solution

See msfp_surveyresponse Entity [msfp_surveyresponse_PrincipalObjectAttributeAccesses](msfp_surveyresponse.md#BKMK_msfp_surveyresponse_PrincipalObjectAttributeAccesses) One-To-Many relationship.
...
See msfp_unsubscribedrecipient Entity [msfp_unsubscribedrecipient_PrincipalObjectAttributeAccesses](msfp_unsubscribedrecipient.md#BKMK_msfp_unsubscribedrecipient_PrincipalObjectAttributeAccesses) One-To-Many relationship.
...
See msdyn_3dmodel Entity [msdyn_3dmodel_PrincipalObjectAttributeAccesses](msdyn_3dmodel.md#BKMK_msdyn_3dmodel_PrincipalObjectAttributeAccesses) One-To-Many relationship.
...
### <a name="BKMK_msdynsm_marketingsitemap_PrincipalObjectAttributeAccesses"></a> msdynsm_marketingsitemap_PrincipalObjectAttributeAccesses

**Added by**: Trial Site Map Customization Solution

See msdynsm_marketingsitemap Entity [msdynsm_marketingsitemap_PrincipalObjectAttributeAccesses](msdynsm_marketingsitemap.md#BKMK_msdynsm_marketingsitemap_PrincipalObjectAttributeAccesses) One-To-Many relationship.

### <a name="BKMK_msdynsm_salessitemap_PrincipalObjectAttributeAccesses"></a> msdynsm_salessitemap_PrincipalObjectAttributeAccesses

**Added by**: Trial Site Map Customization Solution

See msdynsm_salessitemap Entity [msdynsm_salessitemap_PrincipalObjectAttributeAccesses](msdynsm_salessitemap.md#BKMK_msdynsm_salessitemap_PrincipalObjectAttributeAccesses) One-To-Many relationship.

### <a name="BKMK_msdynsm_servicessitemap_PrincipalObjectAttributeAccesses"></a> msdynsm_servicessitemap_PrincipalObjectAttributeAccesses

**Added by**: Trial Site Map Customization Solution

See msdynsm_servicessitemap Entity [msdynsm_servicessitemap_PrincipalObjectAttributeAccesses](msdynsm_servicessitemap.md#BKMK_msdynsm_servicessitemap_PrincipalObjectAttributeAccesses) One-To-Many relationship.

### <a name="BKMK_msdynsm_settingssitemap_PrincipalObjectAttributeAccesses"></a> msdynsm_settingssitemap_PrincipalObjectAttributeAccesses

**Added by**: Trial Site Map Customization Solution

See msdynsm_settingssitemap Entity [msdynsm_settingssitemap_PrincipalObjectAttributeAccesses](msdynsm_settingssitemap.md#BKMK_msdynsm_settingssitemap_PrincipalObjectAttributeAccesses) One-To-Many relationship.
