---
title: "msdyn_playbookactivity Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
description: "Includes schema information and supported messages for the msdyn_playbookactivity entity."
ms.date: 03/28/2019
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/msdyn_playbookactivities(*msdyn_playbookactivityid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST [*org URI*]/api/data/v9.0/msdyn_playbookactivities<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/msdyn_playbookactivities(*msdyn_playbookactivityid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref href="Microsoft.Dynamics.CRM.GrantAccess?text=GrantAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|IsValidStateTransition|<xref href="Microsoft.Dynamics.CRM.IsValidStateTransition?text=IsValidStateTransition Function" />|<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
|ModifyAccess|<xref href="Microsoft.Dynamics.CRM.ModifyAccess?text=ModifyAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET [*org URI*]/api/data/v9.0/msdyn_playbookactivities(*msdyn_playbookactivityid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/msdyn_playbookactivities<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref href="Microsoft.Dynamics.CRM.RetrievePrincipalAccess?text=RetrievePrincipalAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref href="Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?text=RetrieveSharedPrincipalsAndAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref href="Microsoft.Dynamics.CRM.RevokeAccess?text=RevokeAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|SetState|PATCH [*org URI*]/api/data/v9.0/msdyn_playbookactivities(*msdyn_playbookactivityid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/msdyn_playbookactivities(*msdyn_playbookactivityid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
|10258|MarketingSiteMap|
|10259|SalesSiteMap|
|10260|ServicesSiteMap|
|10261|SettingsSiteMap|
...
Same as syncerror entity [msdyn_playbookactivity_SyncErrors](syncerror.md#BKMK_msdyn_playbookactivity_SyncErrors) Many-To-One relationship.
...
Same as duplicaterecord entity [msdyn_playbookactivity_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_playbookactivity_DuplicateMatchingRecord) Many-To-One relationship.
...
Same as duplicaterecord entity [msdyn_playbookactivity_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_playbookactivity_DuplicateBaseRecord) Many-To-One relationship.
...
Same as sharepointdocumentlocation entity [msdyn_playbookactivity_SharePointDocumentLocations](sharepointdocumentlocation.md#BKMK_msdyn_playbookactivity_SharePointDocumentLocations) Many-To-One relationship.
...
Same as sharepointdocument entity [msdyn_playbookactivity_SharePointDocuments](sharepointdocument.md#BKMK_msdyn_playbookactivity_SharePointDocuments) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_playbookactivity_SharePointDocuments|
...
Same as asyncoperation entity [msdyn_playbookactivity_AsyncOperations](asyncoperation.md#BKMK_msdyn_playbookactivity_AsyncOperations) Many-To-One relationship.
...
Same as mailboxtrackingfolder entity [msdyn_playbookactivity_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_playbookactivity_MailboxTrackingFolders) Many-To-One relationship.
...
Same as userentityinstancedata entity [msdyn_playbookactivity_UserEntityInstanceDatas](userentityinstancedata.md#BKMK_msdyn_playbookactivity_UserEntityInstanceDatas) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_playbookactivity_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
Same as processsession entity [msdyn_playbookactivity_ProcessSession](processsession.md#BKMK_msdyn_playbookactivity_ProcessSession) Many-To-One relationship.
...
Same as bulkdeletefailure entity [msdyn_playbookactivity_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_playbookactivity_BulkDeleteFailures) Many-To-One relationship.
...
Same as principalobjectattributeaccess entity [msdyn_playbookactivity_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_playbookactivity_PrincipalObjectAttributeAccesses) Many-To-One relationship.
...
Same as msdyn_playbookactivityattribute entity [msdyn_playbookactivity_msdyn_playbookactivityattribute](msdyn_playbookactivityattribute.md#BKMK_msdyn_playbookactivity_msdyn_playbookactivityattribute) Many-To-One relationship.
...
See systemuser Entity [lk_msdyn_playbookactivity_createdby](systemuser.md#BKMK_lk_msdyn_playbookactivity_createdby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_playbookactivity_createdonbehalfby"></a> lk_msdyn_playbookactivity_createdonbehalfby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_playbookactivity_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_playbookactivity_createdonbehalfby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_playbookactivity_modifiedby"></a> lk_msdyn_playbookactivity_modifiedby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_playbookactivity_modifiedby](systemuser.md#BKMK_lk_msdyn_playbookactivity_modifiedby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_playbookactivity_modifiedonbehalfby"></a> lk_msdyn_playbookactivity_modifiedonbehalfby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_playbookactivity_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_playbookactivity_modifiedonbehalfby) One-To-Many relationship.

### <a name="BKMK_user_msdyn_playbookactivity"></a> user_msdyn_playbookactivity

**Added by**: System Solution Solution

See systemuser Entity [user_msdyn_playbookactivity](systemuser.md#BKMK_user_msdyn_playbookactivity) One-To-Many relationship.

### <a name="BKMK_team_msdyn_playbookactivity"></a> team_msdyn_playbookactivity

**Added by**: System Solution Solution

See team Entity [team_msdyn_playbookactivity](team.md#BKMK_team_msdyn_playbookactivity) One-To-Many relationship.

### <a name="BKMK_business_unit_msdyn_playbookactivity"></a> business_unit_msdyn_playbookactivity

**Added by**: System Solution Solution

See businessunit Entity [business_unit_msdyn_playbookactivity](businessunit.md#BKMK_business_unit_msdyn_playbookactivity) One-To-Many relationship.

### <a name="BKMK_msdyn_playbooktemplate_msdyn_playbookactivity"></a> msdyn_playbooktemplate_msdyn_playbookactivity

See msdyn_playbooktemplate Entity [msdyn_playbooktemplate_msdyn_playbookactivity](msdyn_playbooktemplate.md#BKMK_msdyn_playbooktemplate_msdyn_playbookactivity) One-To-Many relationship.
...
<xref href="Microsoft.Dynamics.CRM.msdyn_playbookactivity?text=msdyn_playbookactivity EntityType" />