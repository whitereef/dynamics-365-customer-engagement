---
title: "SyncError Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
- [msdynsm_marketingsitemap_SyncErrors](#BKMK_msdynsm_marketingsitemap_SyncErrors)
- [msdynsm_salessitemap_SyncErrors](#BKMK_msdynsm_salessitemap_SyncErrors)
- [msdynsm_servicessitemap_SyncErrors](#BKMK_msdynsm_servicessitemap_SyncErrors)
- [msdynsm_settingssitemap_SyncErrors](#BKMK_msdynsm_settingssitemap_SyncErrors)
...
See holidaywrapper Entity [holidaywrapper_SyncErrors](holidaywrapper.md#BKMK_holidaywrapper_SyncErrors) One-To-Many relationship.
...
See msfp_emailtemplate Entity [msfp_emailtemplate_SyncErrors](msfp_emailtemplate.md#BKMK_msfp_emailtemplate_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msfp_question_SyncErrors"></a> msfp_question_SyncErrors

**Added by**: Microsoft Forms Pro Solution

See msfp_question Entity [msfp_question_SyncErrors](msfp_question.md#BKMK_msfp_question_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msfp_questionresponse_SyncErrors"></a> msfp_questionresponse_SyncErrors

**Added by**: Microsoft Forms Pro Solution

See msfp_questionresponse Entity [msfp_questionresponse_SyncErrors](msfp_questionresponse.md#BKMK_msfp_questionresponse_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msfp_survey_SyncErrors"></a> msfp_survey_SyncErrors

**Added by**: Microsoft Forms Pro Solution

See msfp_survey Entity [msfp_survey_SyncErrors](msfp_survey.md#BKMK_msfp_survey_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msfp_surveyinvite_SyncErrors"></a> msfp_surveyinvite_SyncErrors

**Added by**: Active Solution Solution

See msfp_surveyinvite Entity [msfp_surveyinvite_SyncErrors](msfp_surveyinvite.md#BKMK_msfp_surveyinvite_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msfp_surveyresponse_SyncErrors"></a> msfp_surveyresponse_SyncErrors

**Added by**: Active Solution Solution

See msfp_surveyresponse Entity [msfp_surveyresponse_SyncErrors](msfp_surveyresponse.md#BKMK_msfp_surveyresponse_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msfp_unsubscribedrecipient_SyncErrors"></a> msfp_unsubscribedrecipient_SyncErrors

**Added by**: Microsoft Forms Pro Solution

See msfp_unsubscribedrecipient Entity [msfp_unsubscribedrecipient_SyncErrors](msfp_unsubscribedrecipient.md#BKMK_msfp_unsubscribedrecipient_SyncErrors) One-To-Many relationship.
...
See msdyn_3dmodel Entity [msdyn_3dmodel_SyncErrors](msdyn_3dmodel.md#BKMK_msdyn_3dmodel_SyncErrors) One-To-Many relationship.
...
### <a name="BKMK_msdynsm_marketingsitemap_SyncErrors"></a> msdynsm_marketingsitemap_SyncErrors

**Added by**: Trial Site Map Customization Solution

See msdynsm_marketingsitemap Entity [msdynsm_marketingsitemap_SyncErrors](msdynsm_marketingsitemap.md#BKMK_msdynsm_marketingsitemap_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msdynsm_salessitemap_SyncErrors"></a> msdynsm_salessitemap_SyncErrors

**Added by**: Trial Site Map Customization Solution

See msdynsm_salessitemap Entity [msdynsm_salessitemap_SyncErrors](msdynsm_salessitemap.md#BKMK_msdynsm_salessitemap_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msdynsm_servicessitemap_SyncErrors"></a> msdynsm_servicessitemap_SyncErrors

**Added by**: Trial Site Map Customization Solution

See msdynsm_servicessitemap Entity [msdynsm_servicessitemap_SyncErrors](msdynsm_servicessitemap.md#BKMK_msdynsm_servicessitemap_SyncErrors) One-To-Many relationship.

### <a name="BKMK_msdynsm_settingssitemap_SyncErrors"></a> msdynsm_settingssitemap_SyncErrors

**Added by**: Trial Site Map Customization Solution

See msdynsm_settingssitemap Entity [msdynsm_settingssitemap_SyncErrors](msdynsm_settingssitemap.md#BKMK_msdynsm_settingssitemap_SyncErrors) One-To-Many relationship.
