---
title: "SavedQuery Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
|msdyn_IsProjectTemplatesView|<xref href="Microsoft.Dynamics.CRM.msdyn_IsProjectTemplatesView?text=msdyn_IsProjectTemplatesView Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
...
|ReferencedEntityNavigationPropertyName|userentityinstancedata_savedquery|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
