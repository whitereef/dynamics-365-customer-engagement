---
title: "msdyn_rolecompetencyrequirement Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
description: "Includes schema information and supported messages for the msdyn_rolecompetencyrequirement entity."
ms.date: 03/28/2019
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/msdyn_rolecompetencyrequirements(*msdyn_rolecompetencyrequirementid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST [*org URI*]/api/data/v9.0/msdyn_rolecompetencyrequirements<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/msdyn_rolecompetencyrequirements(*msdyn_rolecompetencyrequirementid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref href="Microsoft.Dynamics.CRM.GrantAccess?text=GrantAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|IsValidStateTransition|<xref href="Microsoft.Dynamics.CRM.IsValidStateTransition?text=IsValidStateTransition Function" />|<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
|ModifyAccess|<xref href="Microsoft.Dynamics.CRM.ModifyAccess?text=ModifyAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET [*org URI*]/api/data/v9.0/msdyn_rolecompetencyrequirements(*msdyn_rolecompetencyrequirementid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/msdyn_rolecompetencyrequirements<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref href="Microsoft.Dynamics.CRM.RetrievePrincipalAccess?text=RetrievePrincipalAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref href="Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?text=RetrieveSharedPrincipalsAndAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref href="Microsoft.Dynamics.CRM.RevokeAccess?text=RevokeAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|SetState|PATCH [*org URI*]/api/data/v9.0/msdyn_rolecompetencyrequirements(*msdyn_rolecompetencyrequirementid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/msdyn_rolecompetencyrequirements(*msdyn_rolecompetencyrequirementid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|

## Entity Properties

|Property|Value|
|--------|-----|
|CollectionSchemaName|msdyn_rolecompetencyrequirements|
|DisplayCollectionName|Role competency requirement|
|DisplayName|Role competency requirement|
|EntitySetName|msdyn_rolecompetencyrequirements|
|IsBPFEntity|False|
|LogicalCollectionName|msdyn_rolecompetencyrequirements|
|LogicalName|msdyn_rolecompetencyrequirement|
|OwnershipType|UserOwned|
|PrimaryIdAttribute|msdyn_rolecompetencyrequirementid|
|PrimaryNameAttribute|msdyn_name|
|SchemaName|msdyn_rolecompetencyrequirement|
...
- [msdyn_rolecompetencyrequirementId](#BKMK_msdyn_rolecompetencyrequirementId)
...
### <a name="BKMK_msdyn_rolecompetencyrequirementId"></a> msdyn_rolecompetencyrequirementId
...
|IsValidForRead|True|
|IsValidForUpdate|False|
|LogicalName|msdyn_rolecompetencyrequirementid|
...
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_SyncErrors|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_DuplicateMatchingRecord|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_DuplicateBaseRecord|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_AsyncOperations|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_MailboxTrackingFolders|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_ProcessSession|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: NoCascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_BulkDeleteFailures|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_PrincipalObjectAttributeAccesses|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rolecompetencyrequirement_Annotations|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
...
- [lk_msdyn_rolecompetencyrequirement_createdby](#BKMK_lk_msdyn_rolecompetencyrequirement_createdby)
- [lk_msdyn_rolecompetencyrequirement_createdonbehalfby](#BKMK_lk_msdyn_rolecompetencyrequirement_createdonbehalfby)
- [lk_msdyn_rolecompetencyrequirement_modifiedby](#BKMK_lk_msdyn_rolecompetencyrequirement_modifiedby)
- [lk_msdyn_rolecompetencyrequirement_modifiedonbehalfby](#BKMK_lk_msdyn_rolecompetencyrequirement_modifiedonbehalfby)
- [user_msdyn_rolecompetencyrequirement](#BKMK_user_msdyn_rolecompetencyrequirement)
...
See systemuser Entity [lk_msdyn_rolecompetencyrequirement_createdby](systemuser.md#BKMK_lk_msdyn_rolecompetencyrequirement_createdby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_rolecompetencyrequirement_createdonbehalfby"></a> lk_msdyn_rolecompetencyrequirement_createdonbehalfby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_rolecompetencyrequirement_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_rolecompetencyrequirement_createdonbehalfby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_rolecompetencyrequirement_modifiedby"></a> lk_msdyn_rolecompetencyrequirement_modifiedby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_rolecompetencyrequirement_modifiedby](systemuser.md#BKMK_lk_msdyn_rolecompetencyrequirement_modifiedby) One-To-Many relationship.
...
See systemuser Entity [lk_msdyn_rolecompetencyrequirement_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_rolecompetencyrequirement_modifiedonbehalfby) One-To-Many relationship.

### <a name="BKMK_user_msdyn_rolecompetencyrequirement"></a> user_msdyn_rolecompetencyrequirement

**Added by**: System Solution Solution

See systemuser Entity [user_msdyn_rolecompetencyrequirement](systemuser.md#BKMK_user_msdyn_rolecompetencyrequirement) One-To-Many relationship.

### <a name="BKMK_team_msdyn_rolecompetencyrequirement"></a> team_msdyn_rolecompetencyrequirement

**Added by**: System Solution Solution

See team Entity [team_msdyn_rolecompetencyrequirement](team.md#BKMK_team_msdyn_rolecompetencyrequirement) One-To-Many relationship.

### <a name="BKMK_business_unit_msdyn_rolecompetencyrequirement"></a> business_unit_msdyn_rolecompetencyrequirement

**Added by**: System Solution Solution

See businessunit Entity [business_unit_msdyn_rolecompetencyrequirement](businessunit.md#BKMK_business_unit_msdyn_rolecompetencyrequirement) One-To-Many relationship.
...
See bookableresourcecategory Entity [msdyn_bookableresourcecategory_msdyn_rolecompetencyrequirement_resourcecategory](bookableresourcecategory.md#BKMK_msdyn_bookableresourcecategory_msdyn_rolecompetencyrequirement_resourcecategory) One-To-Many relationship.
...
See characteristic Entity [msdyn_characteristic_msdyn_rolecompetencyrequirement_characteristic](characteristic.md#BKMK_msdyn_characteristic_msdyn_rolecompetencyrequirement_characteristic) One-To-Many relationship.
...
See ratingvalue Entity [msdyn_ratingvalue_msdyn_rolecompetencyrequirement_ratingvalue](ratingvalue.md#BKMK_msdyn_ratingvalue_msdyn_rolecompetencyrequirement_ratingvalue) One-To-Many relationship.
