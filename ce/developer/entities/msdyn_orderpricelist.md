---
title: "msdyn_orderpricelist Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
description: "Includes schema information and supported messages for the msdyn_orderpricelist entity."
ms.date: 03/28/2019
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/msdyn_orderpricelists(*msdyn_orderpricelistid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST [*org URI*]/api/data/v9.0/msdyn_orderpricelists<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/msdyn_orderpricelists(*msdyn_orderpricelistid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref href="Microsoft.Dynamics.CRM.GrantAccess?text=GrantAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|IsValidStateTransition|<xref href="Microsoft.Dynamics.CRM.IsValidStateTransition?text=IsValidStateTransition Function" />|<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
|ModifyAccess|<xref href="Microsoft.Dynamics.CRM.ModifyAccess?text=ModifyAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET [*org URI*]/api/data/v9.0/msdyn_orderpricelists(*msdyn_orderpricelistid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/msdyn_orderpricelists<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref href="Microsoft.Dynamics.CRM.RetrievePrincipalAccess?text=RetrievePrincipalAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref href="Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?text=RetrieveSharedPrincipalsAndAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref href="Microsoft.Dynamics.CRM.RevokeAccess?text=RevokeAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|SetState|PATCH [*org URI*]/api/data/v9.0/msdyn_orderpricelists(*msdyn_orderpricelistid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/msdyn_orderpricelists(*msdyn_orderpricelistid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|

## Entity Properties

|Property|Value|
|--------|-----|
|CollectionSchemaName|msdyn_orderpricelists|
|DisplayCollectionName|Project Contract Project Price Lists|
|DisplayName|Project Contract Project Price List|
|EntitySetName|msdyn_orderpricelists|
|IsBPFEntity|False|
|LogicalCollectionName|msdyn_orderpricelists|
|LogicalName|msdyn_orderpricelist|
|OwnershipType|UserOwned|
|PrimaryIdAttribute|msdyn_orderpricelistid|
|PrimaryNameAttribute|msdyn_description|
|SchemaName|msdyn_orderpricelist|
...
- [msdyn_orderpricelistId](#BKMK_msdyn_orderpricelistId)
...
### <a name="BKMK_msdyn_orderpricelistId"></a> msdyn_orderpricelistId
...
|IsValidForRead|True|
|IsValidForUpdate|False|
|LogicalName|msdyn_orderpricelistid|
...
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_SyncErrors|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_DuplicateMatchingRecord|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_DuplicateBaseRecord|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_AsyncOperations|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_MailboxTrackingFolders|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_ProcessSession|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: NoCascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_BulkDeleteFailures|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_PrincipalObjectAttributeAccesses|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_orderpricelist_Annotations|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
...
- [lk_msdyn_orderpricelist_createdby](#BKMK_lk_msdyn_orderpricelist_createdby)
- [lk_msdyn_orderpricelist_createdonbehalfby](#BKMK_lk_msdyn_orderpricelist_createdonbehalfby)
- [lk_msdyn_orderpricelist_modifiedby](#BKMK_lk_msdyn_orderpricelist_modifiedby)
- [lk_msdyn_orderpricelist_modifiedonbehalfby](#BKMK_lk_msdyn_orderpricelist_modifiedonbehalfby)
- [user_msdyn_orderpricelist](#BKMK_user_msdyn_orderpricelist)
...
See systemuser Entity [lk_msdyn_orderpricelist_createdby](systemuser.md#BKMK_lk_msdyn_orderpricelist_createdby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_orderpricelist_createdonbehalfby"></a> lk_msdyn_orderpricelist_createdonbehalfby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_orderpricelist_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_orderpricelist_createdonbehalfby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_orderpricelist_modifiedby"></a> lk_msdyn_orderpricelist_modifiedby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_orderpricelist_modifiedby](systemuser.md#BKMK_lk_msdyn_orderpricelist_modifiedby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_orderpricelist_modifiedonbehalfby"></a> lk_msdyn_orderpricelist_modifiedonbehalfby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_orderpricelist_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_orderpricelist_modifiedonbehalfby) One-To-Many relationship.

### <a name="BKMK_user_msdyn_orderpricelist"></a> user_msdyn_orderpricelist

**Added by**: System Solution Solution

See systemuser Entity [user_msdyn_orderpricelist](systemuser.md#BKMK_user_msdyn_orderpricelist) One-To-Many relationship.

### <a name="BKMK_team_msdyn_orderpricelist"></a> team_msdyn_orderpricelist

**Added by**: System Solution Solution

See team Entity [team_msdyn_orderpricelist](team.md#BKMK_team_msdyn_orderpricelist) One-To-Many relationship.

### <a name="BKMK_business_unit_msdyn_orderpricelist"></a> business_unit_msdyn_orderpricelist

**Added by**: System Solution Solution

See businessunit Entity [business_unit_msdyn_orderpricelist](businessunit.md#BKMK_business_unit_msdyn_orderpricelist) One-To-Many relationship.

### <a name="BKMK_msdyn_pricelevel_msdyn_orderpricelist_PriceList"></a> msdyn_pricelevel_msdyn_orderpricelist_PriceList

**Added by**: Product Management Solution

See pricelevel Entity [msdyn_pricelevel_msdyn_orderpricelist_PriceList](pricelevel.md#BKMK_msdyn_pricelevel_msdyn_orderpricelist_PriceList) One-To-Many relationship.

### <a name="BKMK_msdyn_salesorder_msdyn_orderpricelist_Contract"></a> msdyn_salesorder_msdyn_orderpricelist_Contract

**Added by**: Sales Solution

See salesorder Entity [msdyn_salesorder_msdyn_orderpricelist_Contract](salesorder.md#BKMK_msdyn_salesorder_msdyn_orderpricelist_Contract) One-To-Many relationship.
