...
- [msdyn_processnotes_msfp_surveyinvites](#BKMK_msdyn_processnotes_msfp_surveyinvites)
- [msdyn_processnotes_msfp_surveyresponses](#BKMK_msdyn_processnotes_msfp_surveyresponses)
...
### <a name="BKMK_msdyn_processnotes_msfp_surveyinvites"></a> msdyn_processnotes_msfp_surveyinvites

**Added by**: Active Solution Solution

Same as msfp_surveyinvite entity [msdyn_processnotes_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_processnotes_msfp_surveyinvites) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_processnotes_msfp_surveyinvites|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|


### <a name="BKMK_msdyn_processnotes_msfp_surveyresponses"></a> msdyn_processnotes_msfp_surveyresponses

**Added by**: Active Solution Solution

Same as msfp_surveyresponse entity [msdyn_processnotes_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_processnotes_msfp_surveyresponses) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_processnotes_msfp_surveyresponses|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
