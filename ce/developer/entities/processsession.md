...
See msfp_emailtemplate Entity [msfp_emailtemplate_ProcessSession](msfp_emailtemplate.md#BKMK_msfp_emailtemplate_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msfp_question_ProcessSession"></a> msfp_question_ProcessSession

**Added by**: Microsoft Forms Pro Solution

See msfp_question Entity [msfp_question_ProcessSession](msfp_question.md#BKMK_msfp_question_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msfp_questionresponse_ProcessSession"></a> msfp_questionresponse_ProcessSession

**Added by**: Microsoft Forms Pro Solution

See msfp_questionresponse Entity [msfp_questionresponse_ProcessSession](msfp_questionresponse.md#BKMK_msfp_questionresponse_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msfp_survey_ProcessSession"></a> msfp_survey_ProcessSession

**Added by**: Microsoft Forms Pro Solution

See msfp_survey Entity [msfp_survey_ProcessSession](msfp_survey.md#BKMK_msfp_survey_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msfp_surveyinvite_ProcessSession"></a> msfp_surveyinvite_ProcessSession

**Added by**: Active Solution Solution

See msfp_surveyinvite Entity [msfp_surveyinvite_ProcessSession](msfp_surveyinvite.md#BKMK_msfp_surveyinvite_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msfp_surveyresponse_ProcessSession"></a> msfp_surveyresponse_ProcessSession

**Added by**: Active Solution Solution

See msfp_surveyresponse Entity [msfp_surveyresponse_ProcessSession](msfp_surveyresponse.md#BKMK_msfp_surveyresponse_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msfp_unsubscribedrecipient_ProcessSession"></a> msfp_unsubscribedrecipient_ProcessSession

**Added by**: Microsoft Forms Pro Solution

See msfp_unsubscribedrecipient Entity [msfp_unsubscribedrecipient_ProcessSession](msfp_unsubscribedrecipient.md#BKMK_msfp_unsubscribedrecipient_ProcessSession) One-To-Many relationship.
...
See msdyn_3dmodel Entity [msdyn_3dmodel_ProcessSession](msdyn_3dmodel.md#BKMK_msdyn_3dmodel_ProcessSession) One-To-Many relationship.
...
### <a name="BKMK_msdynsm_marketingsitemap_ProcessSession"></a> msdynsm_marketingsitemap_ProcessSession

**Added by**: Trial Site Map Customization Solution

See msdynsm_marketingsitemap Entity [msdynsm_marketingsitemap_ProcessSession](msdynsm_marketingsitemap.md#BKMK_msdynsm_marketingsitemap_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msdynsm_salessitemap_ProcessSession"></a> msdynsm_salessitemap_ProcessSession

**Added by**: Trial Site Map Customization Solution

See msdynsm_salessitemap Entity [msdynsm_salessitemap_ProcessSession](msdynsm_salessitemap.md#BKMK_msdynsm_salessitemap_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msdynsm_servicessitemap_ProcessSession"></a> msdynsm_servicessitemap_ProcessSession

**Added by**: Trial Site Map Customization Solution

See msdynsm_servicessitemap Entity [msdynsm_servicessitemap_ProcessSession](msdynsm_servicessitemap.md#BKMK_msdynsm_servicessitemap_ProcessSession) One-To-Many relationship.

### <a name="BKMK_msdynsm_settingssitemap_ProcessSession"></a> msdynsm_settingssitemap_ProcessSession

**Added by**: Trial Site Map Customization Solution

See msdynsm_settingssitemap Entity [msdynsm_settingssitemap_ProcessSession](msdynsm_settingssitemap.md#BKMK_msdynsm_settingssitemap_ProcessSession) One-To-Many relationship.
