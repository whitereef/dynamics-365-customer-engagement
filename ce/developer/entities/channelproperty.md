---
title: "ChannelProperty Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|Create|POST [*org URI*]/api/data/v9.0/channelproperties<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/channelproperties(*channelpropertyid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/channelproperties(*channelpropertyid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/channelproperties<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.0/channelproperties(*channelpropertyid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
|DisplayCollectionName|Channel Properties|
|DisplayName|Channel Property|
|EntitySetName|channelproperties|
|IsBPFEntity|False|
|LogicalCollectionName|channelproperties|
|LogicalName|channelproperty|
|OwnershipType|OrganizationOwned|
|PrimaryIdAttribute|channelpropertyid|
...
|Property|Value|
|--------|-----|
|Description|Type the name of the application that the property is associated with.|
|DisplayName|Application Source|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|applicationsource|
|MaxLength|100|
|RequiredLevel|None|
|Type|String|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the channel property|
|DisplayName|Channel Property|
|IsValidForForm|False|
|IsValidForRead|True|
|IsValidForUpdate|False|
|LogicalName|channelpropertyid|
...
|Property|Value|
|--------|-----|
|Description|Enter the data type for the property.|
...
|Property|Value|
|--------|-----|
|Description|Type the name of the property as received in the information provided by the external application.|
|DisplayName|Name|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
...
|Property|Value|
|--------|-----|
|Description|Properties contained with a particular bag.|
...
|Property|Value|
|--------|-----|
|Description|State of the channel property|
|DisplayName|Status|
|IsValidForForm|True|
|IsValidForRead|True|
|IsValidForUpdate|False|
...
|Property|Value|
|--------|-----|
|Description|Status of the channel property|
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|channelpropertyidunique|
|RequiredLevel|SystemRequired|
|Type|Uniqueidentifier|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the organization associated with the channel property.|
...
|Property|Value|
|--------|-----|
|Description|Version number of the channel property.|
...
<xref href="Microsoft.Dynamics.CRM.channelproperty?text=channelproperty EntityType" />