---
title: "MailboxTrackingFolder Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
- [msdynsm_marketingsitemap_MailboxTrackingFolders](#BKMK_msdynsm_marketingsitemap_MailboxTrackingFolders)
- [msdynsm_salessitemap_MailboxTrackingFolders](#BKMK_msdynsm_salessitemap_MailboxTrackingFolders)
- [msdynsm_servicessitemap_MailboxTrackingFolders](#BKMK_msdynsm_servicessitemap_MailboxTrackingFolders)
- [msdynsm_settingssitemap_MailboxTrackingFolders](#BKMK_msdynsm_settingssitemap_MailboxTrackingFolders)
...
See holidaywrapper Entity [holidaywrapper_MailboxTrackingFolders](holidaywrapper.md#BKMK_holidaywrapper_MailboxTrackingFolders) One-To-Many relationship.
...
See msfp_emailtemplate Entity [msfp_emailtemplate_MailboxTrackingFolders](msfp_emailtemplate.md#BKMK_msfp_emailtemplate_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msfp_question_MailboxTrackingFolders"></a> msfp_question_MailboxTrackingFolders

**Added by**: Microsoft Forms Pro Solution

See msfp_question Entity [msfp_question_MailboxTrackingFolders](msfp_question.md#BKMK_msfp_question_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msfp_questionresponse_MailboxTrackingFolders"></a> msfp_questionresponse_MailboxTrackingFolders

**Added by**: Microsoft Forms Pro Solution

See msfp_questionresponse Entity [msfp_questionresponse_MailboxTrackingFolders](msfp_questionresponse.md#BKMK_msfp_questionresponse_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msfp_survey_MailboxTrackingFolders"></a> msfp_survey_MailboxTrackingFolders

**Added by**: Microsoft Forms Pro Solution

See msfp_survey Entity [msfp_survey_MailboxTrackingFolders](msfp_survey.md#BKMK_msfp_survey_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msfp_surveyinvite_MailboxTrackingFolders"></a> msfp_surveyinvite_MailboxTrackingFolders

**Added by**: Active Solution Solution

See msfp_surveyinvite Entity [msfp_surveyinvite_MailboxTrackingFolders](msfp_surveyinvite.md#BKMK_msfp_surveyinvite_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msfp_surveyresponse_MailboxTrackingFolders"></a> msfp_surveyresponse_MailboxTrackingFolders

**Added by**: Active Solution Solution

See msfp_surveyresponse Entity [msfp_surveyresponse_MailboxTrackingFolders](msfp_surveyresponse.md#BKMK_msfp_surveyresponse_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msfp_unsubscribedrecipient_MailboxTrackingFolders"></a> msfp_unsubscribedrecipient_MailboxTrackingFolders

**Added by**: Microsoft Forms Pro Solution

See msfp_unsubscribedrecipient Entity [msfp_unsubscribedrecipient_MailboxTrackingFolders](msfp_unsubscribedrecipient.md#BKMK_msfp_unsubscribedrecipient_MailboxTrackingFolders) One-To-Many relationship.
...
See msdyn_3dmodel Entity [msdyn_3dmodel_MailboxTrackingFolders](msdyn_3dmodel.md#BKMK_msdyn_3dmodel_MailboxTrackingFolders) One-To-Many relationship.
...
### <a name="BKMK_msdynsm_marketingsitemap_MailboxTrackingFolders"></a> msdynsm_marketingsitemap_MailboxTrackingFolders

**Added by**: Trial Site Map Customization Solution

See msdynsm_marketingsitemap Entity [msdynsm_marketingsitemap_MailboxTrackingFolders](msdynsm_marketingsitemap.md#BKMK_msdynsm_marketingsitemap_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msdynsm_salessitemap_MailboxTrackingFolders"></a> msdynsm_salessitemap_MailboxTrackingFolders

**Added by**: Trial Site Map Customization Solution

See msdynsm_salessitemap Entity [msdynsm_salessitemap_MailboxTrackingFolders](msdynsm_salessitemap.md#BKMK_msdynsm_salessitemap_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msdynsm_servicessitemap_MailboxTrackingFolders"></a> msdynsm_servicessitemap_MailboxTrackingFolders

**Added by**: Trial Site Map Customization Solution

See msdynsm_servicessitemap Entity [msdynsm_servicessitemap_MailboxTrackingFolders](msdynsm_servicessitemap.md#BKMK_msdynsm_servicessitemap_MailboxTrackingFolders) One-To-Many relationship.

### <a name="BKMK_msdynsm_settingssitemap_MailboxTrackingFolders"></a> msdynsm_settingssitemap_MailboxTrackingFolders

**Added by**: Trial Site Map Customization Solution

See msdynsm_settingssitemap Entity [msdynsm_settingssitemap_MailboxTrackingFolders](msdynsm_settingssitemap.md#BKMK_msdynsm_settingssitemap_MailboxTrackingFolders) One-To-Many relationship.
