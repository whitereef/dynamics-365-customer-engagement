...
- [int_CustomerEffort](#BKMK_int_CustomerEffort)
- [int_UpSellReferral](#BKMK_int_UpSellReferral)
...
### <a name="BKMK_int_CustomerEffort"></a> int_CustomerEffort

**Added by**: FreeTrialBaseSolution2 Solution

|Property|Value|
|--------|-----|
|Description|Shows customer satisfaction by tracking effort required by the customer. Low scores typically mean higher customer satisfaction as the customer had to travel through less channels to find a resolution|
|DisplayName|Customer Effort|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|int_customereffort|
|RequiredLevel|None|
|Type|Picklist|

#### int_CustomerEffort Options
...
### <a name="BKMK_int_UpSellReferral"></a> int_UpSellReferral

**Added by**: FreeTrialBaseSolution2 Solution

|Property|Value|
|--------|-----|
|Description|Mark Yes if an opportunity exists to sell additional products or services to the customer.|
|DisplayName|UpSell Referral|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|int_upsellreferral|
|RequiredLevel|None|
|Type|Boolean|

#### int_UpSellReferral Options
...
|IsHierarchical|False|
|IsCustomizable|False|
|ReferencedEntityNavigationPropertyName|userentityinstancedata_incident|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|False|
|ReferencedEntityNavigationPropertyName|incident_topic|
|AssociatedMenuConfiguration|Behavior: UseCollectionName<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
Same as msfp_surveyinvite entity [incident_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_incident_msfp_surveyinvites) Many-To-One relationship.
...
Same as msfp_surveyresponse entity [incident_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_incident_msfp_surveyresponses) Many-To-One relationship.
