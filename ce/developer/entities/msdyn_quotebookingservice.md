---
title: "msdyn_quotebookingservice Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
### <a name="BKMK_msdyn_quotebookingservice_msfp_surveyinvites"></a> msdyn_quotebookingservice_msfp_surveyinvites

**Added by**: Active Solution Solution

Same as msfp_surveyinvite entity [msdyn_quotebookingservice_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_quotebookingservice_msfp_surveyinvites) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_quotebookingservice_msfp_surveyinvites|
...
Same as msfp_surveyresponse entity [msdyn_quotebookingservice_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_quotebookingservice_msfp_surveyresponses) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_quotebookingservice_msfp_surveyresponses|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: Cascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: Cascade<br />Share: Cascade<br />Unshare: Cascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_quotebookingservice_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
