---
title: "msdyn_solutionhealthruleargument Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
description: "Includes schema information and supported messages for the msdyn_solutionhealthruleargument entity."
ms.date: 03/28/2019
...
Same as syncerror entity [msdyn_solutionhealthruleargument_SyncErrors](syncerror.md#BKMK_msdyn_solutionhealthruleargument_SyncErrors) Many-To-One relationship.
...
Same as userentityinstancedata entity [msdyn_solutionhealthruleargument_UserEntityInstanceDatas](userentityinstancedata.md#BKMK_msdyn_solutionhealthruleargument_UserEntityInstanceDatas) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_solutionhealthruleargument_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
