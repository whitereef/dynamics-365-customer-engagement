---
title: "msdyn_rmareceipt Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
Same as msfp_surveyinvite entity [msdyn_rmareceipt_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_rmareceipt_msfp_surveyinvites) Many-To-One relationship.
...
Same as msfp_surveyresponse entity [msdyn_rmareceipt_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_rmareceipt_msfp_surveyresponses) Many-To-One relationship.
...
Same as sharepointdocument entity [msdyn_rmareceipt_SharePointDocuments](sharepointdocument.md#BKMK_msdyn_rmareceipt_SharePointDocuments) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rmareceipt_SharePointDocuments|
...
Same as userentityinstancedata entity [msdyn_rmareceipt_UserEntityInstanceDatas](userentityinstancedata.md#BKMK_msdyn_rmareceipt_UserEntityInstanceDatas) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_rmareceipt_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
