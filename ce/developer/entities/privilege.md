---
title: "Privilege Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
|Property|Value|
|--------|-----|
|IntersectAttribute|entityaccesslevelid|
|IsCustomizable|False|
|LogicalName|privilege|
|NavigationPropertyName|ChannelAccessProfile_Privilege|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
...
|IntersectAttribute|channelaccessprofileid|
|NavigationPropertyName|ChannelAccessProfile_Privilege|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
