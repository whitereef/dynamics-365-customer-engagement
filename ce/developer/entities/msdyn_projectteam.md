---
title: "msdyn_projectteam Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
- [msdyn_projectteam_msfp_surveyinvites](#BKMK_msdyn_projectteam_msfp_surveyinvites)
- [msdyn_projectteam_msfp_surveyresponses](#BKMK_msdyn_projectteam_msfp_surveyresponses)
...
### <a name="BKMK_msdyn_projectteam_msfp_surveyinvites"></a> msdyn_projectteam_msfp_surveyinvites

**Added by**: Active Solution Solution

Same as msfp_surveyinvite entity [msdyn_projectteam_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_projectteam_msfp_surveyinvites) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_projectteam_msfp_surveyinvites|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: Cascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: Cascade<br />Share: Cascade<br />Unshare: Cascade|


### <a name="BKMK_msdyn_projectteam_msfp_surveyresponses"></a> msdyn_projectteam_msfp_surveyresponses

**Added by**: Active Solution Solution

Same as msfp_surveyresponse entity [msdyn_projectteam_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_projectteam_msfp_surveyresponses) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_projectteam_msfp_surveyresponses|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: Cascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: Cascade<br />Share: Cascade<br />Unshare: Cascade|
