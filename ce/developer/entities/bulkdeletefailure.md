---
title: "BulkDeleteFailure Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
- [msdynsm_marketingsitemap_BulkDeleteFailures](#BKMK_msdynsm_marketingsitemap_BulkDeleteFailures)
- [msdynsm_salessitemap_BulkDeleteFailures](#BKMK_msdynsm_salessitemap_BulkDeleteFailures)
- [msdynsm_servicessitemap_BulkDeleteFailures](#BKMK_msdynsm_servicessitemap_BulkDeleteFailures)
- [msdynsm_settingssitemap_BulkDeleteFailures](#BKMK_msdynsm_settingssitemap_BulkDeleteFailures)
...
See holidaywrapper Entity [holidaywrapper_BulkDeleteFailures](holidaywrapper.md#BKMK_holidaywrapper_BulkDeleteFailures) One-To-Many relationship.
...
See msfp_emailtemplate Entity [msfp_emailtemplate_BulkDeleteFailures](msfp_emailtemplate.md#BKMK_msfp_emailtemplate_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msfp_question_BulkDeleteFailures"></a> msfp_question_BulkDeleteFailures

**Added by**: Microsoft Forms Pro Solution

See msfp_question Entity [msfp_question_BulkDeleteFailures](msfp_question.md#BKMK_msfp_question_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msfp_questionresponse_BulkDeleteFailures"></a> msfp_questionresponse_BulkDeleteFailures

**Added by**: Microsoft Forms Pro Solution

See msfp_questionresponse Entity [msfp_questionresponse_BulkDeleteFailures](msfp_questionresponse.md#BKMK_msfp_questionresponse_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msfp_survey_BulkDeleteFailures"></a> msfp_survey_BulkDeleteFailures

**Added by**: Microsoft Forms Pro Solution

See msfp_survey Entity [msfp_survey_BulkDeleteFailures](msfp_survey.md#BKMK_msfp_survey_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msfp_surveyinvite_BulkDeleteFailures"></a> msfp_surveyinvite_BulkDeleteFailures

**Added by**: Active Solution Solution

See msfp_surveyinvite Entity [msfp_surveyinvite_BulkDeleteFailures](msfp_surveyinvite.md#BKMK_msfp_surveyinvite_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msfp_surveyresponse_BulkDeleteFailures"></a> msfp_surveyresponse_BulkDeleteFailures

**Added by**: Active Solution Solution

See msfp_surveyresponse Entity [msfp_surveyresponse_BulkDeleteFailures](msfp_surveyresponse.md#BKMK_msfp_surveyresponse_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msfp_unsubscribedrecipient_BulkDeleteFailures"></a> msfp_unsubscribedrecipient_BulkDeleteFailures

**Added by**: Microsoft Forms Pro Solution

See msfp_unsubscribedrecipient Entity [msfp_unsubscribedrecipient_BulkDeleteFailures](msfp_unsubscribedrecipient.md#BKMK_msfp_unsubscribedrecipient_BulkDeleteFailures) One-To-Many relationship.
...
See msdyn_3dmodel Entity [msdyn_3dmodel_BulkDeleteFailures](msdyn_3dmodel.md#BKMK_msdyn_3dmodel_BulkDeleteFailures) One-To-Many relationship.
...
### <a name="BKMK_msdynsm_marketingsitemap_BulkDeleteFailures"></a> msdynsm_marketingsitemap_BulkDeleteFailures

**Added by**: Trial Site Map Customization Solution

See msdynsm_marketingsitemap Entity [msdynsm_marketingsitemap_BulkDeleteFailures](msdynsm_marketingsitemap.md#BKMK_msdynsm_marketingsitemap_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msdynsm_salessitemap_BulkDeleteFailures"></a> msdynsm_salessitemap_BulkDeleteFailures

**Added by**: Trial Site Map Customization Solution

See msdynsm_salessitemap Entity [msdynsm_salessitemap_BulkDeleteFailures](msdynsm_salessitemap.md#BKMK_msdynsm_salessitemap_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msdynsm_servicessitemap_BulkDeleteFailures"></a> msdynsm_servicessitemap_BulkDeleteFailures

**Added by**: Trial Site Map Customization Solution

See msdynsm_servicessitemap Entity [msdynsm_servicessitemap_BulkDeleteFailures](msdynsm_servicessitemap.md#BKMK_msdynsm_servicessitemap_BulkDeleteFailures) One-To-Many relationship.

### <a name="BKMK_msdynsm_settingssitemap_BulkDeleteFailures"></a> msdynsm_settingssitemap_BulkDeleteFailures

**Added by**: Trial Site Map Customization Solution

See msdynsm_settingssitemap Entity [msdynsm_settingssitemap_BulkDeleteFailures](msdynsm_settingssitemap.md#BKMK_msdynsm_settingssitemap_BulkDeleteFailures) One-To-Many relationship.
