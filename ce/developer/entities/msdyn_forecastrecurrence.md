---
title: "msdyn_forecastrecurrence Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
Same as userentityinstancedata entity [msdyn_forecastrecurrence_UserEntityInstanceDatas](userentityinstancedata.md#BKMK_msdyn_forecastrecurrence_UserEntityInstanceDatas) Many-To-One relationship.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_forecastrecurrence_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
