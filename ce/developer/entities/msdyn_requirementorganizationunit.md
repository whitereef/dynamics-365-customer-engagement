...
search.app: 
  ...
  - D365CE
---
# msdyn_requirementorganizationunit Entity Reference
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/msdyn_requirementorganizationunits(*msdyn_requirementorganizationunitid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST [*org URI*]/api/data/v9.0/msdyn_requirementorganizationunits<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/msdyn_requirementorganizationunits(*msdyn_requirementorganizationunitid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref href="Microsoft.Dynamics.CRM.GrantAccess?text=GrantAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|IsValidStateTransition|<xref href="Microsoft.Dynamics.CRM.IsValidStateTransition?text=IsValidStateTransition Function" />|<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
|ModifyAccess|<xref href="Microsoft.Dynamics.CRM.ModifyAccess?text=ModifyAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET [*org URI*]/api/data/v9.0/msdyn_requirementorganizationunits(*msdyn_requirementorganizationunitid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/msdyn_requirementorganizationunits<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref href="Microsoft.Dynamics.CRM.RetrievePrincipalAccess?text=RetrievePrincipalAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref href="Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?text=RetrieveSharedPrincipalsAndAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref href="Microsoft.Dynamics.CRM.RevokeAccess?text=RevokeAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|SetState|PATCH [*org URI*]/api/data/v9.0/msdyn_requirementorganizationunits(*msdyn_requirementorganizationunitid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/msdyn_requirementorganizationunits(*msdyn_requirementorganizationunitid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|

## Entity Properties

|Property|Value|
|--------|-----|
|CollectionSchemaName|msdyn_requirementorganizationunits|
|DisplayCollectionName|Requirement Organization Units|
|DisplayName|Requirement Organization Unit|
|EntitySetName|msdyn_requirementorganizationunits|
|IsBPFEntity|False|
|LogicalCollectionName|msdyn_requirementorganizationunits|
|LogicalName|msdyn_requirementorganizationunit|
|OwnershipType|UserOwned|
|PrimaryIdAttribute|msdyn_requirementorganizationunitid|
|PrimaryNameAttribute|msdyn_name|
|SchemaName|msdyn_requirementorganizationunit|
...
- [msdyn_requirementorganizationunitId](#BKMK_msdyn_requirementorganizationunitId)
...
|Property|Value|
|--------|-----|
|Description|The preferred organizational unit for a requirement|
...
### <a name="BKMK_msdyn_requirementorganizationunitId"></a> msdyn_requirementorganizationunitId
...
|IsValidForRead|True|
|IsValidForUpdate|False|
|LogicalName|msdyn_requirementorganizationunitid|
...
|Property|Value|
|--------|-----|
|Description|Status of the Requirement Organization Unit|
|DisplayName|Status|
...
|Property|Value|
|--------|-----|
|Description|Reason for the status of the Requirement Organization Unit|
...
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_SyncErrors|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_DuplicateMatchingRecord|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_DuplicateBaseRecord|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_AsyncOperations|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_MailboxTrackingFolders|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_UserEntityInstanceDatas|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_ProcessSession|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: NoCascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_BulkDeleteFailures|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_requirementorganizationunit_PrincipalObjectAttributeAccesses|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: |
|CascadeConfiguration|Assign: NoCascade<br />Delete: Cascade<br />Merge: NoCascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
See systemuser Entity [lk_msdyn_requirementorganizationunit_createdby](systemuser.md#BKMK_lk_msdyn_requirementorganizationunit_createdby) One-To-Many relationship.
...
See systemuser Entity [lk_msdyn_requirementorganizationunit_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_requirementorganizationunit_createdonbehalfby) One-To-Many relationship.

### <a name="BKMK_lk_msdyn_requirementorganizationunit_modifiedby"></a> lk_msdyn_requirementorganizationunit_modifiedby

**Added by**: System Solution Solution

See systemuser Entity [lk_msdyn_requirementorganizationunit_modifiedby](systemuser.md#BKMK_lk_msdyn_requirementorganizationunit_modifiedby) One-To-Many relationship.
...
See systemuser Entity [lk_msdyn_requirementorganizationunit_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_requirementorganizationunit_modifiedonbehalfby) One-To-Many relationship.

### <a name="BKMK_user_msdyn_requirementorganizationunit"></a> user_msdyn_requirementorganizationunit

**Added by**: System Solution Solution

See systemuser Entity [user_msdyn_requirementorganizationunit](systemuser.md#BKMK_user_msdyn_requirementorganizationunit) One-To-Many relationship.

### <a name="BKMK_team_msdyn_requirementorganizationunit"></a> team_msdyn_requirementorganizationunit

**Added by**: System Solution Solution

See team Entity [team_msdyn_requirementorganizationunit](team.md#BKMK_team_msdyn_requirementorganizationunit) One-To-Many relationship.

### <a name="BKMK_business_unit_msdyn_requirementorganizationunit"></a> business_unit_msdyn_requirementorganizationunit

**Added by**: System Solution Solution

See businessunit Entity [business_unit_msdyn_requirementorganizationunit](businessunit.md#BKMK_business_unit_msdyn_requirementorganizationunit) One-To-Many relationship.
...
See msdyn_organizationalunit Entity [msdyn_organizationalunit_requirementorganizationunit_OrganizationalUnit](msdyn_organizationalunit.md#BKMK_msdyn_organizationalunit_requirementorganizationunit_OrganizationalUnit) One-To-Many relationship.
...
See msdyn_resourcerequirement Entity [msdyn_resourcerequirement_requirementorganizationunit_ResourceRequirement](msdyn_resourcerequirement.md#BKMK_msdyn_resourcerequirement_requirementorganizationunit_ResourceRequirement) One-To-Many relationship.
...
<xref href="Microsoft.Dynamics.CRM.msdyn_requirementorganizationunit?text=msdyn_requirementorganizationunit EntityType" />