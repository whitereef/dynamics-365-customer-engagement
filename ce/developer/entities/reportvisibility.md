---
title: "ReportVisibility Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|Create|POST [*org URI*]/api/data/v9.0/reportvisibilities<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/reportvisibilities(*reportvisibilityid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/reportvisibilities(*reportvisibilityid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/reportvisibilities<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.0/reportvisibilities(*reportvisibilityid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
|DisplayCollectionName|Report Visibilities|
|DisplayName|Report Visibility|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the report visibility record.|
|DisplayName|Report Visibility|
|IsValidForForm|False|
|IsValidForRead|True|
|IsValidForUpdate|False|
|LogicalName|reportvisibilityid|
|RequiredLevel|SystemRequired|
...
|Property|Value|
|--------|-----|
|Description|Type of visibility of the report.|
|DisplayName|Visibility|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|visibilitycode|
|RequiredLevel|SystemRequired|
|Type|Picklist|

#### VisibilityCode Options

|Value|Label|
|-----|-----|
|1|Reports area|
|2|Forms for related record types|
|3|Lists for related record types|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the user who created the report visibility record.|
...
|Description|Date and time when the report visibility record was created.|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the delegate user who created the reportvisibility.|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the user who last modified the report visibility record.|
...
|--------|-----|
|DateTimeBehavior|UserLocal|
|Description|Date and time when the report visibility record was last modified.|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the delegate user who last modified the reportvisibility.|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the user or team who owns the report visibility.|
|DisplayName|Owner|
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|ownerid|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the business unit that owns the report visibility record.|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier of the user who owns the report visibility record.|
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|reportvisibilityidunique|
|RequiredLevel|SystemRequired|
|Type|Uniqueidentifier|
...
<xref href="Microsoft.Dynamics.CRM.reportvisibility?text=reportvisibility EntityType" />