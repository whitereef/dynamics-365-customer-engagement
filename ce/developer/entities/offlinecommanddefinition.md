---
title: "OfflineCommandDefinition Entity Reference (Dynamics 365 for Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|Create|POST [*org URI*]/api/data/v9.0/offlinecommanddefinitions<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/offlinecommanddefinitions(*commanddefinitionid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/offlinecommanddefinitions(*commanddefinitionid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/offlinecommanddefinitions<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.0/offlinecommanddefinitions(*commanddefinitionid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
- [CommandDefinition](#BKMK_CommandDefinition)
- [CommandDefinitionId](#BKMK_CommandDefinitionId)
- [CommandName](#BKMK_CommandName)
...
See systemuser Entity [lk_offlinecommanddefinition_modifiedonbehalfby](systemuser.md#BKMK_lk_offlinecommanddefinition_modifiedonbehalfby) One-To-Many relationship.

### <a name="BKMK_lk_offlinecommanddefinition_createdonbehalfby"></a> lk_offlinecommanddefinition_createdonbehalfby

See systemuser Entity [lk_offlinecommanddefinition_createdonbehalfby](systemuser.md#BKMK_lk_offlinecommanddefinition_createdonbehalfby) One-To-Many relationship.

### <a name="BKMK_offlinecommanddefinition_organization"></a> offlinecommanddefinition_organization

See organization Entity [offlinecommanddefinition_organization](organization.md#BKMK_offlinecommanddefinition_organization) One-To-Many relationship.

### <a name="BKMK_lk_offlinecommanddefinition_modifiedby"></a> lk_offlinecommanddefinition_modifiedby

See systemuser Entity [lk_offlinecommanddefinition_modifiedby](systemuser.md#BKMK_lk_offlinecommanddefinition_modifiedby) One-To-Many relationship.
